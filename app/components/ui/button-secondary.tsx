export function ButtonSecondary({
  ...
  return (
    <button
      className="group relative overflow-hidden rounded-xl bg-muted/40 px-3 py-2 text-sm font-bold text-foreground transition-all active:scale-95 sm:px-4 sm:py-3 sm:text-base"
      {...rest}
    >
      {children}
